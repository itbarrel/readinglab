...
class FormsTest < ApplicationSystemTestCase
  ...
  test 'should create form' do
    ...
    fill_in 'Account', with: @form.account_id
    check 'Active' if @form.active
    check 'Assessment' if @form.assessment
    check 'Attendance' if @form.attendance
    fill_in 'Deleted at', with: @form.deleted_at
    fill_in 'Fields', with: @form.fields
    fill_in 'Lesson', with: @form.lesson
