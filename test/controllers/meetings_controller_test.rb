...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create meeting' do
    assert_difference('Meeting.count') do
      post meetings_url,
           params: { meeting: { account_id: @meeting.account_id, active: @meeting.active, cancel: @meeting.cancel,
                                deleted_at: @meeting.deleted_at, form_id: @meeting.form_id, klass_id: @meeting.klass_id, start: @meeting.start } }
    end
