...
class FormDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create form_detail" do
    assert_difference("FormDetail.count") do
      post form_details_url, params: { form_detail: { account_id: @form_detail.account_id, active: @form_detail.active, deleted_at: @form_detail.deleted_at, form_id: @form_detail.form_id, form_values: @form_detail.form_values, parent_id: @form_detail.parent_id, parent_types: @form_detail.parent_types, user_id: @form_detail.user_id } }
    end
  ...
  test "should update form_detail" do
    patch form_detail_url(@form_detail), params: { form_detail: { account_id: @form_detail.account_id, active: @form_detail.active, deleted_at: @form_detail.deleted_at, form_id: @form_detail.form_id, form_values: @form_detail.form_values, parent_id: @form_detail.parent_id, parent_types: @form_detail.parent_types, user_id: @form_detail.user_id } }
