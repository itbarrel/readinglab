...
class MeetingstudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meetingstudent" do
    assert_difference("Meetingstudent.count") do
      post meetingstudents_url, params: { meetingstudent: { account_id: @meetingstudent.account_id, active: @meetingstudent.active, attended: @meetingstudent.attended, deleted_at: @meetingstudent.deleted_at, meeting_id: @meetingstudent.meeting_id, user_id: @meetingstudent.user_id } }
    end
  ...
  test "should update meetingstudent" do
    patch meetingstudent_url(@meetingstudent), params: { meetingstudent: { account_id: @meetingstudent.account_id, active: @meetingstudent.active, attended: @meetingstudent.attended, deleted_at: @meetingstudent.deleted_at, meeting_id: @meetingstudent.meeting_id, user_id: @meetingstudent.user_id } }
