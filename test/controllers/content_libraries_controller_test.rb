...
class ContentLibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create content_library' do
    assert_difference('ContentLibrary.count') do
      post content_libraries_url,
           params: { content_library: { account_id: @content_library.account_id, active: @content_library.active,
                                        deleted_at: @content_library.deleted_at, public: @content_library.public, title: @content_library.title } }
    end
  ...
  test 'should update content_library' do
    patch content_library_url(@content_library),
          params: { content_library: { account_id: @content_library.account_id, active: @content_library.active,
                                       deleted_at: @content_library.deleted_at, public: @content_library.public, title: @content_library.title } }
