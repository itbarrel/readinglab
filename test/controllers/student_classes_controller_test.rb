...
class StudentClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create student_class' do
    assert_difference('StudentClass.count') do
      post student_classes_url,
           params: { student_class: { account_id: @student_class.account_id, avtive: @student_class.avtive,
                                      deleted_at: @student_class.deleted_at, klass_id: @student_class.klass_id, start: @student_class.start, student_id: @student_class.student_id } }
    end
  ...
  test 'should update student_class' do
    patch student_class_url(@student_class),
          params: { student_class: { account_id: @student_class.account_id, avtive: @student_class.avtive,
                                     deleted_at: @student_class.deleted_at, klass_id: @student_class.klass_id, start: @student_class.start, student_id: @student_class.student_id } }
