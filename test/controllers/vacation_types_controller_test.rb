...
class VacationTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create vacation_type' do
    assert_difference('VacationType.count') do
      post vacation_types_url,
           params: { vacation_type: { account_id: @vacation_type.account_id, active: @vacation_type.active,
                                      boolean: @vacation_type.boolean, deleted_at: @vacation_type.deleted_at, description: @vacation_type.description, name: @vacation_type.name, references: @vacation_type.references } }
    end
  ...
  test 'should update vacation_type' do
    patch vacation_type_url(@vacation_type),
          params: { vacation_type: { account_id: @vacation_type.account_id, active: @vacation_type.active,
                                     boolean: @vacation_type.boolean, deleted_at: @vacation_type.deleted_at, description: @vacation_type.description, name: @vacation_type.name, references: @vacation_type.references } }
