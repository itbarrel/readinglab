class KlassTemplatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @klass_template.save
        format.html { redirect_to klass_template_url(@klass_template), notice: "Klass template was successfully created." }
  ...
  def update
    respond_to do |format|
      if @klass_template.update(klass_template_params)
        format.html { redirect_to klass_template_url(@klass_template), notice: "Klass template was successfully updated." }
  ...
  private
    ...
    def klass_template_params
      params.require(:klass_template).permit(:max_students, :active, :start, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday, :sunday, :settings, :session_range, :duration, :min_students, :name, :description, :deleted_at, :account_id, :user_id, :room_id)
    end
end
